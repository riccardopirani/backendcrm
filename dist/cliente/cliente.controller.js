...
let ClienteController = class ClienteController {
  ...
  async create(createClienteDto, request) {
  ...
  async updatecliente(id, updateClienteDto, request) {
...
__decorate(
  [
    ...
    __metadata("design:paramtypes", [
      create_cliente_dto_1.CreateClienteDto,
      Object,
    ]),
...
__decorate(
  [
    ...
    __metadata("design:paramtypes", [
      String,
      update_cliente_dto_1.UpdateClienteDto,
      Object,
    ]),
    __metadata("design:returntype", Promise),
  ],
